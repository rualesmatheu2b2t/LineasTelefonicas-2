...
class Empresa:
    ...
    def modificarDescuento(self):
        cdescuento = self.descuentoLinea
        self.descuento = cdescuento
    ...
    def metodo3(self):
        return "el promedio es: " + f"{self.linea1.promedioMinutosLlamada}, {self.linea2.promedioMinutosLlamada}, {self.linea3.promedioMinutosLlamada}"
